...
const items = [
  ...
  // IT продукты
  { name: "Смартфон", image: pelisos, category: "IT продукты" },
  { name: "Планшет", image: Стиральная, category: "IT продукты" },
  { name: "Умные часы", image: Посудомоечная, category: "IT продукты" },


  // ТВ / Аудио / Видео
  { name: "Телевизор", image: Микроволновая, category: "ТВ / Аудио / Видео" },
  { name: "Саундбар", image: Кондиционер, category: "ТВ / Аудио / Видео" },
  { name: "Домашний кинотеатр", image: Варочная, category: "ТВ / Аудио / Видео" },
];
