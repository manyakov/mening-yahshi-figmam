...
import logot from "../../../img/boschh.png"
import hdtp from "../../../img/фон хедер.png"
...
const Navbarbs = () => {
  ...
  return (
    <div style={{
        ...
        <img className="img-fluid bosnav" src={hdtp} alt="rang" />
    <div className="nav-father d-flex justify-content-between align-items-center">
      ...
      <div className="nav-22">
        <img className="img-fluid" src={logot} alt="samso" />
      </div>
